<template>
    <form @submit.prevent="save" class="row col-sm-6 m-auto" method="post">
        <h1 class="text-center">Ajout de chapitre au livre</h1>
        <!-- Email input -->
...
const save = () => {
    form.post(`/chapters/create/${props.book.id}`);
}
